...
@include('partials.head')
  ...
  @include('partials.nav')
    ...
    {{-- @includeIf($testimonial, 'partials.testimonial') --}}
      ...
      <div class="container">
        ...
        <div class="d-block d-md-flex border-bottom">
          <div class="text-center p-4 item border-right" data-aos="fade">
            ...
            <p>The company itself is a very successful company. I will explain to the blinded critic who flees from the pains of life.</p>
