        ...
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://youtube.com/{{$testimonial->video_id}}" class="popup-vimeo image-play">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p><a href="https://youtube.com/{{$testimonial->video_id}}" class="popup-vimeo text-uppercase">Watch Video <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
